...
export function MarketingLandingServices() {
    return (
                ...
                <div className="services-two__top">
                    <div className="section-title text-left sec-title-animation animation-style2">
                        ...
                        <h2 className="section-title__title title-animation">
                            Her türlü etkinlik için <br />
                            <span>ideal</span> <span>çözüm</span>
                        </h2>
                    </div>
                    ...
                    <div className="services-two__services-list">
                        <div className="services-two__services-list-single services-two__services-list-single-1">
                            ...
                            <div className="services-two__service-list-box">
                                <p style={{ color: "#696e73", marginBottom: "20px" }}>
                                    Büyük toplantılarda soru-cevap oturumları için profesyonel çözüm.
                                </p>
                                <ul className="services-two__services-list-inner list-unstyled"></ul>
                            </div>
                            <div className="services-two__hover-img">
                                <img
                                    src="https://imagedelivery.net/prdw3ANMyocSBJD-Do1EeQ/a69f4727-815e-4160-0b98-bbb476013100/soruyorum"
                                    alt=""
                                />
                            </div>
                        </div>
                        <div className="services-two__services-list-single services-two__services-list-single-2">
                            ...
                            <div className="services-two__service-list-box">
                                <p style={{ color: "#696e73", marginBottom: "20px" }}>
                                    Sınıf içi interaktif dersler ve öğrenci katılımını artırma.
                                </p>
                            </div>
                            <div className="services-two__hover-img">
                                <img
                                    src="https://imagedelivery.net/prdw3ANMyocSBJD-Do1EeQ/2cafcd87-66fc-4373-ba42-2cd9ebce0f00/soruyorum"
                                    alt=""
                                />
                            </div>
                        </div>
                        <div className="services-two__services-list-single services-two__services-list-single-3">
                            ...
                            <div className="services-two__service-list-box">
                                <p style={{ color: "#696e73", marginBottom: "20px" }}>
                                    Şirket içi sunumlar ve toplantılarda etkileşimi artırın.
                                </p>
                                <ul className="services-two__services-list-inner list-unstyled"></ul>
                            </div>
                            <div className="services-two__hover-img">
                                <img
                                    src="https://imagedelivery.net/prdw3ANMyocSBJD-Do1EeQ/2e0bfcfe-e57f-4982-fd7d-d595c5e59200/soruyorum"
                                    alt=""
                                />
                            </div>
                        </div>
                        <div className="services-two__services-list-single services-two__services-list-single-3">
                            ...
                            <div className="services-two__service-list-box">
                                <p style={{ color: "#696e73", marginBottom: "20px" }}>
                                    Online eğitim ve seminerlerde katılımcı etkileşimi.
                                </p>
                                <ul className="services-two__services-list-inner list-unstyled"></ul>
                            </div>
                            <div className="services-two__hover-img">
                                <img
                                    src="https://imagedelivery.net/prdw3ANMyocSBJD-Do1EeQ/2d8eb604-e0ef-40fc-039a-d40660c38800/soruyorum"
                                    alt=""
                                />
                            </div>
                        </div>
                        <div className="services-two__services-list-single services-two__services-list-single-3">
                            ...
                            <div className="services-two__service-list-box">
                                <p style={{ color: "#696e73", marginBottom: "20px" }}>
                                    Fuar, festival ve organizasyonlarda anlık geri bildirim.
                                </p>
                                <ul className="services-two__services-list-inner list-unstyled"></ul>
                            </div>
                            <div className="services-two__hover-img">
                                <img
                                    src="https://imagedelivery.net/prdw3ANMyocSBJD-Do1EeQ/0c6e2776-2e2d-49ab-ce38-c545d8986600/soruyorum"
                                    alt=""
                                />
                            </div>
                        </div>
                        <div className="services-two__services-list-single services-two__services-list-single-3">
                            ...
                            <div className="services-two__service-list-box">
                                <p style={{ color: "#696e73", marginBottom: "20px" }}>
                                    Streaming etkinliklerinde soru-cevap oturumları.
                                </p>
                                <ul className="services-two__services-list-inner list-unstyled"></ul>
                            </div>
                            <div className="services-two__hover-img">
                                <img
                                    src="https://imagedelivery.net/prdw3ANMyocSBJD-Do1EeQ/8fe23d76-b42b-407c-b011-2b72be044100/soruyorum"
                                    alt=""
                                />
                            </div>
                        </div>
